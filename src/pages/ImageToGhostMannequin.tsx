...
export default function ImageToGhostMannequin() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-bold text-foreground mb-2">Image to Ghost Mannequin</h1>
        <p className="text-lg text-muted-foreground">
          Create invisible mannequin effects for your products
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>Your ghost mannequin result will appear here</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-border p-12 text-center min-h-[300px]">
              ...
              <p className="text-sm text-muted-foreground">
                Generated ghost mannequin will appear here
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <p className="text-foreground">AI removes the mannequin invisibly</p>
            </div>
            <div className="flex gap-3">
              ...
              <p className="text-foreground">Get professional product photos instantly</p>
            </div>
          </div>
        </CardContent>
      </Card>
