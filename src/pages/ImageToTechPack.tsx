...
export default function ImageToTechPack() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-bold text-foreground mb-2">Image to Tech Pack</h1>
        <p className="text-lg text-muted-foreground">
          Generate technical specification sheets from product images
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>Your tech pack will appear here</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-border p-12 text-center min-h-[300px]">
              ...
              <p className="text-sm text-muted-foreground">
                Generated tech pack will appear here
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <p className="text-foreground">AI analyzes and generates detailed specs</p>
            </div>
            <div className="flex gap-3">
              ...
              <p className="text-foreground">Download professional tech pack documentation</p>
            </div>
          </div>
        </CardContent>
      </Card>
