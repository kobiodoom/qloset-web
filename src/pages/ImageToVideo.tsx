...
export default function ImageToVideo() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-bold text-foreground mb-2">Image to Video</h1>
        <p className="text-lg text-muted-foreground">
          Create dynamic videos from static images
        </p>
      </div>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <p className="text-foreground">AI animates your image into a video</p>
            </div>
            <div className="flex gap-3">
              ...
              <p className="text-foreground">Download your promotional video</p>
            </div>
          </div>
        </CardContent>
      </Card>
